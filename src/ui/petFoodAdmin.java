...
public class petFoodAdmin extends javax.swing.JPanel {
    ...
    public petFoodAdmin(Connection con) {
        initComponents();
        this.con = con;
    }
    ...
    private void initComponents() {
        ...
        petFoodAdminControlArea.setBackground(new java.awt.Color(0, 51, 153));

        btnUpdatePrice.setBackground(new java.awt.Color(102, 204, 255));
        btnUpdatePrice.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnUpdatePrice.setForeground(new java.awt.Color(0, 51, 153));
        ...
        btnOrderProduct.setBackground(new java.awt.Color(102, 204, 255));
        btnOrderProduct.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnOrderProduct.setForeground(new java.awt.Color(0, 51, 153));
        ...
        petFoodAdminWorkArea.setBackground(new java.awt.Color(102, 204, 255));
    ...
    private void btnUpdatePriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePriceActionPerformed
        ...
        petFoodAdminUpdatePrice petFoodUpdatePrice = new petFoodAdminUpdatePrice(con);
