...
public class petGroomingJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblSelectGroomingService.setForeground(new java.awt.Color(0, 51, 153));
        lblSelectGroomingService.setText("                                                                      Select a Grooming Service");

        groomingServiceTable.setForeground(new java.awt.Color(51, 204, 255));
        ...
        lblGroomingServiceName.setForeground(new java.awt.Color(0, 51, 153));
        ...
        lblSelectADate.setForeground(new java.awt.Color(0, 51, 153));
        ...
        lblGroomingServiceCost.setForeground(new java.awt.Color(0, 51, 153));
        lblGroomingServiceCost.setText("Service Cost :");

        btnSubmitBooking.setBackground(new java.awt.Color(0, 51, 153));
