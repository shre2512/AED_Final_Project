...
public class userJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnPetGrooming.setForeground(new java.awt.Color(0, 51, 153));
        ...
        btnPetAccessories.setForeground(new java.awt.Color(0, 51, 153));
        ...
        userPastActivityControlArea.setBackground(new java.awt.Color(0, 51, 153));

        btnAccessoryPurchase.setBackground(new java.awt.Color(51, 204, 255));
        btnAccessoryPurchase.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnAccessoryPurchase.setForeground(new java.awt.Color(0, 51, 153));
        ...
        btnFoodPurchase.setBackground(new java.awt.Color(51, 204, 255));
        btnFoodPurchase.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnFoodPurchase.setForeground(new java.awt.Color(0, 51, 153));
        ...
        userPastActivityWorkArea.setBackground(new java.awt.Color(51, 204, 255));

        jLabel2.setIcon(new javax.swing.ImageIcon("/Users/sagarwhymehta/Desktop/dog ss.png")); // NOI18N
        ...
        userPastActivityWorkAreaLayout.setHorizontalGroup(
            ...
            .addGroup(userPastActivityWorkAreaLayout.createSequentialGroup()
                .addContainerGap()
